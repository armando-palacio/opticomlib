...
5. 🛠️**refactor**: It is used when a modification is made to the code that does not correct errors or add functionality.
...
14. ⚙️**config**: Used for changes to project settings that do not fall into other categories, such as changes to configuration files, environment settings, etc.
